...
if os.path.exists(EXCEL_FILE):
    ...
    # LỌC DỮ LIỆU: Chỉ lấy từ 15/05/2026 và LOẠI BỎ NGÀY KHÔNG GIAO DỊCH
    df = df[(df['Ngày'] >= '2026-05-15') & (df['KL'] > 0) & (df['Đóng cửa'] > 0)]
    ...
    # Vẽ biểu đồ 2 tầng (Giá & MA30 ở trên, Volume ở dưới)
