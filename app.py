...
if os.path.exists(EXCEL_FILE):
    ...
    # Giả định sheet MA30 tên là 'Giá trung bình (30 ngày)'
    ...
    # 3. Hiển thị các thẻ chỉ số nhanh (Metrics)
    latest = df.iloc[-1]
    ...
    # 4. Vẽ biểu đồ hỗn hợp (Nến Nhật + MA30 + Volume)
